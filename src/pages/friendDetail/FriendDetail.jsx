...
const FriendDetails = () => {
  ...
  return (
    <div className="grid grid-cols-10 gap-4 grid-rows-3 mt-10 w-10/12 mx-auto">
      ...
      <div className="col-span-10 sm:col-span-6 px-6 bg-base-100 rounded-md shadow-sm flex justify-between items-center">
        <div>
